...
abstract class ThinkOauth {
    ...
    public function config(){
        $this->Callback = "http://www".DOMAIN."/index.php/addon/execute/_addons/sync_login/_controller/login/_action/callback/type/qq.html";
		// addons_url('SyncLogin://Login/callback',array('type'=>strtolower($this->Type)));
    }
