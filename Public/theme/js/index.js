...
webGameObj.focusFun = function() {
    ...
    t.hide().css("z-index", 0),
    t.eq(0).show().css("z-index", 1),
    e.hover(function() {
        clearInterval(handl)
    },
    function() {
...
webGameObj.pageShow = function() {
    var e = arguments[0],
    t = 0;
    if ("[object Object]" === Object.prototype.toString.call(e) && "undefine" != typeof e.ele && "" !== e.ele && "undefine" != typeof e.data) return t = Math.ceil(e.data.length / e.page),
    $(e.ele).html("<i>1</i>/" + t + '<a target="_self" href="#" class="w-kftabL">&lt;</a><a target="_self" href="#" class="w-kftabR">&gt;</a>'),
    t
},
webGameObj.getDatas = function() {
    ...
    n = e.data,
    s = n.length;
    if ("[object Object]" === Object.prototype.toString.call(e)) return t = e.page * e.index,
    a = t + e.page,
    a > s && (a = s),
    n.slice(t, a)
},
webGameObj.jjkf = function() {
    ...
    e.onlypage = 10,
    $.ajax({
        url: U('Api/Game/ajaxServerlist','type=jjkf'),
        type: "post",
		dataType:"jsonp",
        async: !1,
        dataType:"jsonp",
        success: function(a) {
            e.datas = a,
            e.pages = webGameObj.pageShow({
                data: e.datas,
                ele: "#jjkfbtns",
                page: e.onlypage
            }),
            $("#jjkfbtns").delegate(".w-kftabL", "click",
            function() {
...
webGameObj.newkf = function() {
    ...
    a = function(e) {
		...
		switch(e){
			case "明天":var a = new Date(t.getTime() + 864e5);break;
			case "今天":var a = new Date;break;
			case "后天":var a = new Date(t.getTime() + (864e5*2));break;
			default:var a = new Date("2016-"+e);
		}
        var n = a.getFullYear(),
        s = a.getMonth() + 1,
        i = a.getDate(),
    ...
    e.onlypage = 10,
    $.ajax({
        url: U('Api/Game/ajaxServerlist','type=zxkf'),
        type: "post",
		dataType:"jsonp",
        async: !1,
        dataType: "jsonp",
        success: function(t) {
            ...
            $("#newkfbtns").delegate(".w-kftabL", "click",
            function() {
                if (1 == e.pages) return ! 1;
                var t = $("#newkfbtns i"),
                a = t.text() - 1,
    ...
    $("#jjkfcons").delegate(".w-jjkftx", "click",
    function() {
    ...
    function a() {
        if (o) {
            ...
            for (var h in i) if (d > h) {
                for (var g = i[h], b = g.length, m = 0; b > m; m++) r[g[m]].src = r[g[m]].getAttribute(p),
                r[g[m]].removeAttribute(p),
                u++;
                delete i[h],
                o--
            }
...
$("#w-tjyxbox").append('<a target="_self" class="w-leftbtn" href="#"></a><a target="_self" class="w-rightbtn" href="#"></a>'),
$("#w-wjfcbox").append('<a target="_self" class="w-leftbtn" href="#"></a><a target="_self" class="w-rightbtn" href="#"></a>'),
$("#w-tjyxbox").hover(function() {
    $(this).find(".w-leftbtn").show(),
    $(this).find(".w-rightbtn").show()
},
function() {
    $(this).find(".w-leftbtn").hide(),
    $(this).find(".w-rightbtn").hide()
}),
$("#w-tjyxbox").delegate(".w-leftbtn", "click",
function() {
    var e = $(window).width(),
    t = 1200 > e ? 2 : 3,
    a = $("#w-tjyxbox"),
...
$("#w-wjfcbox").delegate(".w-leftbtn", "click",
function() {
    var e = $(window).width(),
    t = 1200 > e ? 4 : 5,
    a = $("#w-wjfcbox"),
...
webGameObj.gbTabFun = function() {
    ...
    a = function() {
        ...
        e.find("li").each(function(e) {
            var t = [];
            a[e] = [],
            a[e].push($(this).find("h3").text()),
            $(this).find("a").each(function(e) {
                var a = $(this);
                t[e] = [],
                t[e].push(a.attr("v")),
                t[e].push(a.attr("href")),
                t[e].push(a.find("img").attr("a") ? a.find("img").attr("a") : a.find("img").attr("src")),
                t[e].push(a.find("img").attr("alt"))
            }),
            a[e].push(t)
        }),
        t = a
...
webGameObj.newkf(),
webGameObj.notices(),
webGameObj.lazyLoad.init(),
webGameObj.gbTabFun(),
$(".w-jjkflist").delegate(".w-jjkftit", "mouseover",
function() {
    var e = $(this),
    t = e.next(),
    a = t.find("img");
    e.hide().siblings(".w-jjkftit").show(),
    e.siblings(".w-jjkfcons").hide(),
    t.show(),
    a.attr("v") && (a.attr("src", a.attr("v")), a.removeAttr("v"))
}),
$("#w-bzzxtab").delegate("span", "click",
function() {
    var e = $(this).index(),
    t = "cur";
    $(this).addClass(t).siblings().removeClass(t),
    $("#w-bzzxcon > p").eq(e).show().siblings().hide()
});
