...
class HttpCurl
{
     ...
     * - $error string [错误描述]
     */
    public static function request($url, $type, $data = false, $timeout = 10)
    {
        $cl = curl_init();
        // 兼容HTTPS
     ...
     * - $error string [错误描述]
     */
    public static function get($url, $data = false, $timeout = 10)
    {
     ...
     * - $error string [错误描述]
     */
    static public function post($url, $data = false, $timeout = 10)
    {
