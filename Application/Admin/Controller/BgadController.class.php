 ...
 */
class BgadController extends AdminController{
    /**
     * 幻灯片列表
     * @author C0de <47156503@qq.com>
     */
    public function index(){
        ...
        $data_list = D('Bgad')->page(!empty($_GET["p"])?$_GET["p"]:1, C('ADMIN_PAGE_ROWS'))->where($map)->order('id desc')->select();
        $page = new \Common\Util\Page(D('Bgad')->where($map)->count(), C('ADMIN_PAGE_ROWS'));
