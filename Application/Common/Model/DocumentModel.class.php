...
class DocumentModel extends Model{
    ...
    public function update(){
        ...
        if($base_data){
            ...
            $extend_data = $document_extend_object->create($_POST); //子模型数据验证
    ...
    public function getPreviousDocument($info){
        ...
        if(!$previous){
            ...
            $previous['link'] = 'javascript:void(0);';
        }else{
            $previous['link'] = U('News/read/'.$previous['id']);
        }
        return $previous;
    }
