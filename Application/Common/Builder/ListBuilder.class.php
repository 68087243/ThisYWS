            ...
            foreach($this->_right_button_list as $right_button){
                switch($right_button['type']){
                    case 'edit':
                        ...
                        break;
					case 'handle':
                        $right_button['link'] = '<a href="'.U($right_button['url'], array('id' => $data['id'])).'">处理</a> ';
                        break;	
                    case 'forbid':
                        switch($data['status']){
                            case '1':
                    ...
                    case 'self':
                        if(!$right_button['attr']['addon']){
                            $right_button['attr']['href'] = U($right_button['attr']['href'],array('id'=>$data['id']));
                        }else{
            ...
            foreach($this->_field_list as &$field){
                switch($field['type']){
                    ...
                    case 'image':
                        ...
                        break;
					case 'edit':
                        $data[$field['name']] = '<span fieldname="'.$field['name'].'" elementid="'.$data['id'].'" class="edit_plug" >'.$data[$field['name']].'</span>';
                        break;
                    case 'type':
